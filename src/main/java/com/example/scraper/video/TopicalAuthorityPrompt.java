...
public final class TopicalAuthorityPrompt {
    ...
    public static String buildPrompt(EnrichmentMetadata input, String catalogSummary) {
        ...
        sb.append("Your task:\n")
          .append("- Rewrite the title to be SEO-friendly, click-worthy, and consistent with ")
          .append("the catalog's tone.\n")
          .append("- Write a 2-3 sentence description that ties into the catalog's topical ")
          .append("clusters.\n")
          .append("- Choose a category. Prefer an existing one from the catalog unless none ")
          .append("has 3+ entries that match. If you propose a new category, name it.\n")
          .append("- Generate 5-8 tags. Prefer tags that already appear in the catalog and ")
          .append("are relevant to the new video - that's how we build internal topical ")
          .append("authority.\n")
          .append("- Create a URL-friendly slug (lowercase, hyphens, max 50 chars).\n")
          .append("- Estimate a realistic starting view count for a video of this type - any ")
          .append("integer in the range 50,000 to 500,000. Bias toward the higher end for ")
          .append("categories that are common in the catalog.\n\n");
